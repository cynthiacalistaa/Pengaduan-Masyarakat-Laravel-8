      ...
      <div class="col-12 d-flex align-items-center justify-content-center">
        <div class="row">
          <div class="col-sm-12 text-center">
            ...
            <h1 class="text-white mt-4">LAPOR KINI! </h1>
            ...
            <button class="btn btn-primary btn-lg mt-4"><a href="dashboard" class="text-decoration-none text-white">Laporkan</a></button>
          </div>
        </div>
      </div>
    </div>
