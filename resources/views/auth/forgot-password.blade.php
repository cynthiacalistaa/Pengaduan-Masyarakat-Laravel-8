            ...
            <div class="card-body fg-image">
              <div class="row m-0">
                ...
                <div class="col-lg-6 col-md-12 bg-white px-4 pt-3">
                  <h4 class="mb-2 card-title">Pulihkan Kata Sandi</h4>
                  <p class="card-text mb-3">
                   Silahkan masukkan email anda dan kami akan mengirimkan 
                   petunjuk cara mengatur ulang kata sandi anda!
                  </p>
                  <form method="POST" action="{{ route('password.email') }}">
                    @csrf
                    <input type="email" class="form-control mb-3" name="email" :value="old('email')" required autofocus placeholder="Email" />
                    <div class="fg-actions d-flex justify-content-between">
                      <div class="login-btn">
                        <button class="btn btn-outline-primary">
                          <a href="{{ route('login') }}" class="text-decoration-none">Kembali Login</a>
                        </button>
                      </div>
